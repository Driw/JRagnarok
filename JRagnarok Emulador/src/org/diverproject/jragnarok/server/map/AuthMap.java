 ...
 *
 * <p>Controle que permite ao servidor de mapa saber quais os jogadores que estão online.
...
public class AuthMap
{
	...
	/**
	 * Remove todas as autenticações que não são mais válidas para estarem autenticadas.
	 * A invalidez pode ser por código de identificação da conta/personagem ou conexão.
	 */
